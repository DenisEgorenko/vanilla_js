...
beforeEach(()=>{
    city = {
        ...
        houses: [
            ...
            {id: 1,builtAt:2000, repaired: false, address:{number:100, street:{title:"Happy Street"}}},
            {id: 1,builtAt:2020, repaired: false, address:{number:101, street:{title:"Happy Street"}}}
        ],
        governmentBuildings: [
